...
with open('../../device/device_config.json', 'r') as f:
    dconfig = json.load(f)
...
#global config
with open('startup_utils/global_config.json', 'r') as f:
    gconfig = json.load(f)

project_id = gconfig['GCP']['PROJECT_ID']
cloud_region = gconfig['GCP']['CLOUD_REGION']
registry_id = gconfig['GCP']['REGISTRY_ID']
mqtt_bridge_hostname = gconfig['GCP']['MQTT_BRDIGE_HOSTNAME']
mqtt_bridge_port = gconfig['GCP']['MQTT_BRDIGE_PORT']
